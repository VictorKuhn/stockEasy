    ...
    useEffect(() => {
        const getUsuario = async () => {
            try {
                ...
                const { login_usuario, nome_usuario, senha_usuario, nivel_acesso_usuario } = response.data;
                setUsuario({ login_usuario, nome_usuario, senha_usuario, nivel_acesso_usuario });
            } catch (error) {
                console.log(error);
            }
        };
